...
-- ----------------------------
--  Table structure for `blog_category_description`
-- ----------------------------
...
-- ----------------------------
--  Table structure for `blog_category_to_layout`
-- ----------------------------
DROP TABLE IF EXISTS `blog_category_to_layout`;
...
-- ----------------------------
--  Table structure for `blog_category_to_store`
-- ----------------------------
DROP TABLE IF EXISTS `blog_category_to_store`;
...
-- ----------------------------
--  Table structure for `blog_description`
-- ----------------------------
...
-- ----------------------------
--  Table structure for `blog_to_category`
-- ----------------------------
...
-- ----------------------------
--  Table structure for `blog_to_layout`
-- ----------------------------
DROP TABLE IF EXISTS `blog_to_layout`;
...
-- ----------------------------
--  Table structure for `blog_to_store`
-- ----------------------------
DROP TABLE IF EXISTS `blog_to_store`;
...
-- ----------------------------
BEGIN;
INSERT INTO `currency` VALUES ('4', '人民币', 'CNY', '￥', '', '2', '1.00000000', '1', '2015-08-30 22:40:08');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `customer_activity` VALUES ('1', '1', 'register', 'a:2:{s:11:\"customer_id\";i:1;s:4:\"name\";s:7:\"升 赵\";}', '127.0.0.1', '2015-08-29 09:45:15');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `layout` VALUES ('1', 'Home'), ('2', 'Product'), ('3', 'Category'), ('4', 'Default'), ('5', 'Manufacturer'), ('6', 'Account'), ('7', 'Checkout'), ('8', 'Contact'), ('9', 'Sitemap'), ('10', 'Affiliate'), ('11', 'Information'), ('12', 'Compare'), ('13', 'Search'), ('14', 'Footer'), ('15', 'Blog');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `layout_route` VALUES ('38', '6', '0', 'account/%'), ('17', '10', '0', 'affiliate/%'), ('44', '3', '0', 'product/category'), ('42', '1', '0', 'common/home'), ('20', '2', '0', 'product/product'), ('24', '11', '0', 'information/information'), ('23', '7', '0', 'checkout/%'), ('31', '8', '0', 'information/contact'), ('32', '9', '0', 'information/sitemap'), ('34', '4', '0', ''), ('45', '5', '0', 'product/manufacturer'), ('52', '12', '0', 'product/compare'), ('53', '13', '0', 'product/search'), ('54', '15', '0', 'blog/%');
COMMIT;
...
) ENGINE=MyISAM AUTO_INCREMENT=11000 DEFAULT CHARSET=utf8;
...
-- ----------------------------
BEGIN;
INSERT INTO `return_reason` VALUES ('1', '2', '商品送到时已损坏'), ('2', '2', '货不对板'), ('3', '2', '其他错误'), ('4', '2', '质量不好，请提供详细信息'), ('5', '2', '其他原因，请提供详细信息');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `stock_status` VALUES ('7', '2', '有现货'), ('8', '2', '预售中'), ('5', '2', '无现货'), ('6', '2', '2-3天到货');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `url_alias` VALUES ('772', 'information_id=4', 'about_us'), ('847', 'payment=alipay_callback', 'payment_alipay_callback'), ('841', 'information_id=6', 'delivery'), ('842', 'information_id=3', 'privacy'), ('843', 'information_id=5', 'terms');
COMMIT;
